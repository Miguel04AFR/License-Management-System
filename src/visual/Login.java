...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        avatarCircular.setAvatar(new ImageIcon(Login.class.getResource("/visual/google_admin_icon_131692.png")));
        avatarCircular.setBounds(253, 70, 271, 234);
        admin.add(avatarCircular);

        // Nuevo ImagePanel al lado del avatar
        ImagePanel additionalImage = new ImagePanel(new ImageIcon(Login.class.getResource("/visual/logo.png")));
        ...
        lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/visual/llave (1).png")));
        ...
        ImagePanel additionalImage_1 = new ImagePanel(new ImageIcon(Login.class.getResource("/visual/logo_en.png")));
        ...
        avatarCircular_1.setAvatar(new ImageIcon(Login.class.getResource("/visual/financiero (1).png")));
        avatarCircular_1.setBounds(253, 70, 271, 234);
        gestor.add(avatarCircular_1);
        
        ImagePanel additionalImage_2 = new ImagePanel(new ImageIcon(Login.class.getResource("/visual/logo.png")));;
        ...
        lblNewLabel_1_1.setIcon(new ImageIcon(Login.class.getResource("/visual/llave (1).png")));
        ...
        ImagePanel additionalImage_1_1 = new ImagePanel(new ImageIcon(Login.class.getResource("/visual/logo_en.png")));
        ...
        avatarCircular_2.setAvatar(new ImageIcon(Login.class.getResource("/visual/examinar.png")));
        avatarCircular_2.setBounds(253, 70, 271, 234);
        examinador.add(avatarCircular_2);
        
        ImagePanel additionalImage_3 = new ImagePanel(new ImageIcon(Login.class.getResource("/visual/logo.png")));
        ...
        lblNewLabel_1_2.setIcon(new ImageIcon(Login.class.getResource("/visual/llave (1).png")));
        ...
        ImagePanel additionalImage_1_2 = new ImagePanel(new ImageIcon(Login.class.getResource("/visual/logo_en.png")));
        ...
        avatarCircular_3.setAvatar(new ImageIcon(Login.class.getResource("/visual/supervisor.png")));
        avatarCircular_3.setBounds(253, 70, 271, 234);
        supervisor.add(avatarCircular_3);
        
        ImagePanel additionalImage_4 = new ImagePanel(new ImageIcon(Login.class.getResource("/visual/logo.png")));
        ...
        lblNewLabel_1_3.setIcon(new ImageIcon(Login.class.getResource("/visual/llave (1).png")));
        ...
        ImagePanel additionalImage_1_3 = new ImagePanel(new ImageIcon(Login.class.getResource("/visual/logo_en.png")));
